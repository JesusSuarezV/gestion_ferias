...
public class FeriaController {
    ...
    public String listarFeriasDisponibles(Model model,
        ...
        List<Feria> ferias = usuarioService.obtenerUsuarioPorUsername(sesionService.getUsernameFromSession())
                .getMisFerias();
            ...
            if (cantidadDisponible == 0 && fechasCorrectas) {
                ...
                if (cantidadDisponible != 0)
                    redirectAttributes.addFlashAttribute("error",
                            "Algo falló: Asegurese de que no existen versiones de esta feria abiertas");
                else
                    redirectAttributes.addFlashAttribute("error", "Fechas inconsistentes");
